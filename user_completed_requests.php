      ...
      <table class="fl-table">
          ...
          <tbody>
            <?php 
                ...
                $accepted = 'Approved';
                $declined = 'Declined';
                $list_requests = $conn->prepare("SELECT * FROM `transport requests` WHERE (`Status` = ? OR `Status` = ?) AND `user_id` = ?");
                $list_requests->bind_param("ssi", $accepted,$declined,$User_id);
                    ...
                    while($row = $result->fetch_assoc()){
                        ?>
                            <tr>
                                ...
                                <td class="table_scroll"><?php echo $row['Comment']; ?></td>
