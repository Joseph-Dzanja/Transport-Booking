      ...
      <table class="fl-table">
          ...
          <tbody>
            <?php 
                ...
                $pending = 'Pending';
                $list_requests = $conn->prepare("SELECT * FROM `transport requests` WHERE `Status` = ?");
                $list_requests->bind_param("s", $pending);  
                    ...
                    while($row = $result->fetch_assoc()){
                        ?>
                            <tr>
                                ...
                                <td><a class="view_button" href="admin_view_request.php?id=<?php echo $row['RequestNumber']; ?>">View</a></td>
                            </tr>
                        <?php
                    }
                }
